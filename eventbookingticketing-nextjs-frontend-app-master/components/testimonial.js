				...
				>
					<SwiperSlide>
						<div className='testimonial__item'>
							<p className='user__description'>"Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate consequuntur eius sunt cum laborum harum provident error animi ipsam modi debitis dignissimos veniam repudiandae mollitia sed voluptates?"</p>
							<div className='user'>
								<div className='user__image'>
									<img className='img-fluid' src='images/user1.jpg' alt='user 01' />
								</div>
					...
					<SwiperSlide>
						<div className='testimonial__item'>
							...
							<div className='user'>
								<div className='user__image'>
									<img className='img-fluid' src='images/user2.jpg' alt='user 02' />
								</div>
								<div className='user__info'>
					...
					<SwiperSlide>
						<div className='testimonial__item'>
							...
							<div className='user'>
								<div className='user__image'>
									<img className='img-fluid' src='images/user3.jpg' alt='user 02' />
								</div>
								<div className='user__info'>
					...
					<SwiperSlide>
						<div className='testimonial__item'>
							...
							<div className='user'>
								<div className='user__image'>
									<img className='img-fluid' src='images/user4.jpg' alt='user 02' />
								</div>
								<div className='user__info'>
					...
					<SwiperSlide>
						<div className='testimonial__item'>
							...
							<div className='user'>
								<div className='user__image'>
									<img className='img-fluid' src='images/user1.jpg' alt='user 02' />
								</div>
								<div className='user__info'>
