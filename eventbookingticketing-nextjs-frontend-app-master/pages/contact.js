	...
	return (
		<Layout title='Contact'>
			<div className='contact section-padding-b'>
				<div className='contact-image' style={{ backgroundImage: 'url(/images/contact.jpg)' }}>
					<div className='row'>
						<div className='col-md-8 col-lg-6 mx-auto text-center'>
							<h2 className='title'>Contact Us</h2>
							<p className='description'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi eveniet officia officiis omnis magnam totam placeat odio voluptas cum adipisci.</p>
						</div>
					</div>
				</div>
				...
				<div className='container'>
					<div className='row'>
						<div className='col-md-8 col-lg-6 mx-auto'>
							...
							<Accordion className='accordion-flush faq-accordion' defaultActiveKey='0'>
